// ==UserScript==
// @name         02. ATOM Index | V7.9 108 001
// @namespace    http://tampermonkey.net/
// @version      V7.9 108 001
...
console.log("[Helix V7.9 107] Iniciado…");
    ...
    //------------------- Texto Color Fondo NO -------------------------
        ...
        { texto: 'High', 												color: 'Red', 	}, // Eliminamos fondo: '#d13438' para evitar el espacio extra #d13438
...
function iniciarCicloBlink() {
    ...
    // FAVICON
    //
    // Sólo participa si hay Assigned.
    //---------------------------------------------------------
